...
router.post("/newCandidate",(req,res) => {console.log("API Working",req.body)
...
router.post("/postNewScore",(req,res) => {console.log("API Working",req.body)
var test_score = new scoreTable({
    candidateID: req.body.candidateID,
...
router.get("/getHighestScore", (req, res) => {
    scoreTable.find().then((data) => {
      const candidates = []
...
router.get("/getAverageScore", (req, res) => {
    scoreTable.find().then((data) => {
      const rounds = [1,2,3]
